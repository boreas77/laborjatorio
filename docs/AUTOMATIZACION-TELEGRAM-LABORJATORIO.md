...
Este sistema permite enviar textos o audios a un bot de Telegram y recibir un borrador de ficha del Laborjatorio.
...
- Genera una ficha Markdown revisable.
...
4. OpenAI:
   ...
   - generacion del borrador.
5. Telegram:
   - envio del borrador completo.
   - resumen de cambios sugeridos.
   - pregunta final para aprobar, corregir o descartar.
...
3. El borrador incluye:
   - ficha completa.
   - cambios sugeridos para `Herramientas.md`.
   - dudas para Borja.
   - pregunta final para aprobar, corregir o descartar.
...
- convierte notas brutas en borradores utiles.
- transcribe audios.
